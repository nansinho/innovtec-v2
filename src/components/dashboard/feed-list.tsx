  ...
  return (
    <div className="border-b border-gray-100 last:border-b-0">
      <div className="flex gap-3 px-5 py-4">
        {/* Avatar */}
        <div className="relative h-9 w-9 shrink-0 overflow-hidden rounded-full bg-gray-100 ring-2 ring-gray-200">
          {author?.avatar_url ? (
            <Image
                ...
                {showMenu && (
                  <div className="absolute right-0 top-full z-50 mt-1 w-36 overflow-hidden rounded-lg border border-gray-200 bg-white py-1 shadow-lg">
                    <button
                      ...
                      className="flex w-full items-center gap-2 px-3 py-2 text-xs font-medium text-gray-900 hover:bg-gray-50"
                    >
          ...
          {editing ? (
            <div className="mt-2">
              <textarea
                ...
                rows={3}
                className="w-full resize-none rounded-xl bg-gray-50 px-4 py-3 text-sm text-gray-900 outline-none placeholder:text-gray-400 focus:bg-gray-100/80"
              />
              {editImageUrl && (
              ...
              <div className="mt-2 flex items-center justify-between">
                <div>
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 rounded-full px-2 py-1 text-[11px] text-gray-400 hover:bg-gray-100 hover:text-gray-600 disabled:opacity-50"
                  >
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="rounded-full bg-orange-600 px-3 py-1 text-xs font-medium text-white hover:bg-orange-700 disabled:opacity-40"
                  >
            ...
            <>
              ...
              {post.news && (
                <Link
                  ...
                  className="mt-2.5 flex items-start gap-3 rounded-xl bg-gray-50/80 p-3 shadow-sm ring-1 ring-gray-200 transition-all hover:bg-gray-50 hover:shadow-sm"
                >
                  {post.news.image_url ? (
                    ...
                    <div className="flex h-12 w-16 shrink-0 items-center justify-center rounded-lg bg-gray-200">
            ...
            <>
                  ...
                  {comments.map((comment) => {
                    ...
                    return (
                      <div key={comment.id} className="group flex gap-2">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="inline-block rounded-2xl bg-white px-3 py-1.5 shadow-sm ring-1 ring-gray-200">
                          ...
                          <div className="mt-0.5 flex items-center gap-2 pl-1">
                            ...
                            <button
                              ...
                              className="hidden text-[10px] text-gray-400 hover:text-red-500 group-hover:inline-flex"
                              title="Supprimer"
                            >
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 rounded-full bg-white px-4 py-2 text-xs text-gray-900 shadow-sm ring-1 ring-gray-200 outline-none placeholder:text-gray-400 focus:ring-orange-500"
                />
                <button
                  onClick={handleSubmitComment}
                  disabled={submitting || !commentText.trim()}
                  className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-orange-600 text-white shadow-sm transition-all hover:bg-orange-700 disabled:opacity-40"
                >
