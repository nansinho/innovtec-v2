    ...
    <div className="fixed inset-0 z-[300] flex items-center justify-center bg-black/40 backdrop-blur-sm">
      ...
      <div className="relative z-10 mx-4 w-full max-w-md overflow-hidden rounded-xl bg-white shadow-2xl">
        ...
        <div className="px-8 py-6">
          ...
          <button
            onClick={handleClose}
            className="mt-6 w-full rounded-[var(--radius-sm)] bg-[var(--yellow)] py-2 text-sm font-semibold text-white transition-all duration-200 hover:bg-[var(--yellow-hover)] active:scale-[0.98]"
          >
            Merci !
          </button>
        </div>
