...
// ==========================================
// Brand colors: Navy #0B3655, Yellow #C8A84E, White #FFFFFF
// ==========================================
...
export function RexFaitsIcon({ className, size = 48 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <circle cx="24" cy="24" r="23" fill="#E8D9A8" stroke="#C8A84E" strokeWidth="1" />
      <circle cx="24" cy="24" r="20" fill="#FAEEC8" />
      <circle cx="24" cy="24" r="18.5" stroke="#C8A84E" strokeWidth="0.5" fill="none" />
      {/* Personne gauche */}
      ...
      <rect x="21.5" y="14" width="5" height="1.2" rx="0.6" fill="#C8A84E" opacity="0.8" />
      <rect x="20.5" y="17" width="7" height="1.2" rx="0.6" fill="#C8A84E" opacity="0.8" />
      <rect x="21.5" y="20" width="5" height="1.2" rx="0.6" fill="#C8A84E" opacity="0.8" />
    </svg>
  );
}
...
export function RexCausesIcon({ className, size = 48 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      <circle cx="24" cy="24" r="20" fill="#FAEEC8" />
      <circle cx="24" cy="24" r="18.5" stroke="#C8A84E" strokeWidth="0.5" fill="none" />
      <text x="13" y="34" fill="#0B3655" fontSize="28" fontWeight="900" fontFamily="Arial, Helvetica, sans-serif">?</text>
      <text x="26" y="34" fill="#0B3655" fontSize="28" fontWeight="900" fontFamily="Arial, Helvetica, sans-serif">?</text>
    </svg>
  );
}
...
export function RexCausesBadge({ className }: { className?: string }) {
  return (
    <div className={`flex items-center ${className || ""}`}>
      ...
      <div className="rounded-r-lg bg-[#0B3655] px-4 py-1.5 -ml-3 shadow-sm">
...
export function RexActionsIcon({ className, size = 48 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      <circle cx="24" cy="24" r="18.5" stroke="#C8A84E" strokeWidth="0.5" fill="none" />
      {/* Document */}
      <rect x="13" y="10" width="15" height="21" rx="1.5" stroke="#0B3655" strokeWidth="1.8" fill="none" />
      {/* Lignes du document */}
      <line x1="16" y1="15.5" x2="25" y2="15.5" stroke="#0B3655" strokeWidth="1.3" strokeLinecap="round" />
      <line x1="16" y1="19.5" x2="25" y2="19.5" stroke="#0B3655" strokeWidth="1.3" strokeLinecap="round" />
      <line x1="16" y1="23.5" x2="22" y2="23.5" stroke="#0B3655" strokeWidth="1.3" strokeLinecap="round" />
      {/* Crayon */}
      <rect x="30" y="12" width="3.5" height="14" rx="0.5" fill="#C8A84E" transform="rotate(20 31.75 19)" />
      <polygon points="29.5,26 33.5,26 31.5,30" fill="#C8A84E" transform="rotate(20 31.75 28)" />
    </svg>
  );
}
...
export function RexVigilanceIcon({ className, size = 48 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      />
      {/* Barre du ! */}
      <line x1="24" y1="16" x2="24" y2="27" stroke="#0B3655" strokeWidth="3" strokeLinecap="round" />
      {/* Point du ! */}
      <circle cx="24" cy="32" r="1.8" fill="#0B3655" />
    </svg>
  );
}
...
export function RexVigilanceBadge({ className }: { className?: string }) {
  return (
    <div className={`flex items-center ${className || ""}`}>
      ...
      <div className="rounded-r-lg bg-[#0B3655] px-4 py-2 -ml-3 shadow-sm">
...
export const REX_BADGE_SVGS = {
  faits: `<svg width="240" height="56" viewBox="0 0 240 56" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="28" cy="28" r="27" fill="#E8D9A8" stroke="#C8A84E" stroke-width="1"/>
    <circle cx="28" cy="28" r="24" fill="#FAEEC8"/>
    <circle cx="28" cy="28" r="22" stroke="#C8A84E" stroke-width="0.5" fill="none"/>
    ...
    <rect x="25" y="16" width="6" height="1.5" rx="0.75" fill="#C8A84E" opacity="0.8"/>
    <rect x="24" y="20" width="8" height="1.5" rx="0.75" fill="#C8A84E" opacity="0.8"/>
    <rect x="25" y="24" width="6" height="1.5" rx="0.75" fill="#C8A84E" opacity="0.8"/>
  ...
  causes: `<svg width="280" height="60" viewBox="0 0 280 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="30" cy="30" r="29" fill="#E8D9A8" stroke="#C8A84E" stroke-width="1"/>
    <circle cx="30" cy="30" r="26" fill="#FAEEC8"/>
    <circle cx="30" cy="30" r="24" stroke="#C8A84E" stroke-width="0.5" fill="none"/>
    <text x="15" y="42" fill="#0B3655" font-family="Arial,Helvetica,sans-serif" font-size="34" font-weight="900">?</text>
    <text x="32" y="42" fill="#0B3655" font-family="Arial,Helvetica,sans-serif" font-size="34" font-weight="900">?</text>
    <rect x="56" y="6" width="160" height="48" rx="6" fill="#0B3655"/>
  ...
  actions: `<svg width="290" height="60" viewBox="0 0 290 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="30" cy="30" r="26" fill="#FAEEC8"/>
    <circle cx="30" cy="30" r="24" stroke="#C8A84E" stroke-width="0.5" fill="none"/>
    <rect x="17" y="13" width="17" height="25" rx="2" stroke="#0B3655" stroke-width="2" fill="none"/>
    <line x1="21" y1="19" x2="30" y2="19" stroke="#0B3655" stroke-width="1.5" stroke-linecap="round"/>
    <line x1="21" y1="24" x2="30" y2="24" stroke="#0B3655" stroke-width="1.5" stroke-linecap="round"/>
    <line x1="21" y1="29" x2="27" y2="29" stroke="#0B3655" stroke-width="1.5" stroke-linecap="round"/>
    <rect x="30" y="12" width="3.5" height="14" rx="0.5" fill="#C8A84E" transform="rotate(20 31.75 19)"/>
    <polygon points="29.5,26 33.5,26 31.5,30" fill="#C8A84E" transform="rotate(20 31.75 28)"/>
    <rect x="56" y="10" width="185" height="40" rx="6" fill="#0B3655"/>
  ...
  vigilance: `<svg width="260" height="60" viewBox="0 0 260 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="30" cy="30" r="26" fill="#FAEEC8"/>
    <circle cx="30" cy="30" r="24" stroke="#C8A84E" stroke-width="0.5" fill="none"/>
    <path d="M30 9 L48 42 H12 Z" fill="#C8A84E" stroke="#0B3655" stroke-width="1.2" stroke-linejoin="round"/>
    <line x1="30" y1="18" x2="30" y2="31" stroke="#0B3655" stroke-width="3.5" stroke-linecap="round"/>
    <circle cx="30" cy="36" r="2" fill="#0B3655"/>
    <rect x="56" y="10" width="145" height="40" rx="6" fill="#0B3655"/>
