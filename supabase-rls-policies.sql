...
DROP POLICY IF EXISTS "Admin supprime les REX" ON rex;
...
CREATE POLICY "Auteur modifie ses REX" ON rex FOR UPDATE USING (author_id = auth.uid() OR get_my_role() = 'admin');
